  ...
  return (
    <>
      ...
      <div className="hidden lg:flex justify-between items-center bg-teal-950 text-gray-200 text-sm px-10 py-2">
        ...
        <div className="font-semibold text-red-400">24/7 Emergency Care Available</div>
      </div>
        ...
        <div className="container mx-auto px-6">
          <div className="flex items-center justify-between h-20">
            ...
            <nav className="hidden lg:flex items-center space-x-8 font-semibold text-gray-700">
              <Link
                to="/"
                className={`hover:text-teal-600 transition ${location.pathname === "/" ? "text-teal-600" : ""
                  }`}
              >
                Home
              </Link>
              <Link
                to="/about"
                className={`hover:text-teal-600 transition ${location.pathname === "/about" ? "text-teal-600" : ""
                  }`}
              >
                About Us
              </Link>
              <Link
                to="/doctors"
                className={`hover:text-teal-600 transition ${location.pathname === "/doctors" ? "text-teal-600" : ""
                  }`}
              >
                Doctors
              </Link>
                ...
                <AnimatePresence>
                  {isServicesOpen && (
                    <motion.div
                      ...
                      className="absolute left-0 mt-4 w-64 bg-white rounded-lg shadow-xl border"
                    >
                      <Link to="/emr" className="block px-5 py-3 hover:bg-teal-50">
                        EMR
                      </Link>
                      <Link to="/billing" className="block px-5 py-3 hover:bg-teal-50">
                        Billing & Insurance
                      </Link>
                      <Link to="/inventory" className="block px-5 py-3 hover:bg-teal-50">
                        Inventory & Pharmacy
                      </Link>
                      <Link to="/admin-dashboard" className="block px-5 py-3 hover:bg-teal-50">
                        Admin Dashboard
                      </Link>
                    </motion.div>
                  )}
              ...
              <Link
                to="/contact-us"
                className={`hover:text-teal-600 transition ${location.pathname === "/contact-us" ? "text-teal-600" : ""
                  }`}
              >
                Contact Us
              </Link>
              <Link
                to="/login"
                className={`hover:text-teal-600 transition ${location.pathname === "/login" ? "text-teal-600" : ""
                  }`}
              >
                Login
              </Link>
            ...
            <div className="hidden lg:flex items-center space-x-4">
              <Link
                to="/appointment"
                className="bg-linear-to-r from-teal-600 to-teal-700 hover:scale-105 active:scale-95 text-white px-6 py-2.5 rounded-md shadow-lg transition-all duration-300 font-semibold"
              >
                Book Appointment
              </Link>
              <a
            ...
            {isMobileMenuOpen && (
              ...
              >
                <nav className="flex flex-col space-y-4">
                  <Link
                    to="/"
                    className="font-bold text-gray-800 text-lg hover:text-blue-500"
                    onClick={() => setIsMobileMenuOpen(false)}
                  >
                    Home
                  </Link>
                  ...
                  <button
                    onClick={() => setMobileDeptOpen(!mobileDeptOpen)}
                    className="font-bold text-blue-900 text-lg text-left flex justify-between items-center"
                  >
                    Departments
                    <ChevronDown
                      className={`w-4 h-4 transition-transform duration-300 ${mobileDeptOpen ? "rotate-180" : ""
                  ...
                  {/* Patient Management Mobile */}
                  <button
                    onClick={() => setMobilePatientOpen(!mobilePatientOpen)}
                    className="font-bold text-blue-900 text-lg text-left flex justify-between items-center mt-4"
                  >
                    Patient Management
                    <ChevronDown
                      className={`w-4 h-4 transition-transform duration-300 ${mobilePatientOpen ? "rotate-180" : ""
