...
const Departments = () => {
        ...
        {departments.map((dept) => (
          ...
          >
            ...
            <p className="text-sm text-gray-500">
              Head: <span className="font-medium">{dept.department_head}</span>
            </p>
 ...
 Department Status: {dept.status}
            ...
            <button
              onClick={() =>
                navigate(`/departments/${encodeURIComponent(dept.department_name.toLowerCase())}`)
              }
