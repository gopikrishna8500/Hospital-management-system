          ...
          {[
            {
              icon: ShieldCheck,
              title: "Integrity",
              desc: "We prioritize patient data security and ethical healthcare practices.",
            },
            {
              icon: HeartPulse,
              title: "Compassion",
              desc: "Technology designed to enhance patient experience and care.",
            },
            {
              icon: Award,
              title: "Excellence",
              desc: "We deliver high-performance systems with enterprise-grade quality.",
            },
          ].map((val, i) => (
